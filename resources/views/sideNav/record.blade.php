...
<section>
			...
			<input type="checkbox" id="toggle">
				<nav>
					...
					<li><a href="{{ route('appointment') }}">Appointment</a></li>
						<li><a style="background-color:#e9c11f; color: rgb(255, 255, 255);">Patient Health Record</a></li>
	...
	<section>
		...
		<p style="position: inherit; margin: 5px 0 0 4%;">This page store record of APC patient</p>
	</section>